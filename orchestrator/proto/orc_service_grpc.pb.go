...
func (c *userNameClient) GetUser(ctx context.Context, in *Username, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/orc_service.UserName/GetUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserName_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orc_service.UserName/GetUser",
	}
...
var UserName_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "orc_service.UserName",
	...
	Metadata: "proto/orc_service.proto",
}
